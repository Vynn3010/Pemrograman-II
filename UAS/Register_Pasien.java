...
public void loadByIdKunjungan(int idKunjungan) {  //untuk mengambil 1 data dari DB berdasarkan id_kunjungan
    ...
    try (Connection c = Koneksi.getConnection();
        ...
        if (r.next()) {
            ...
            dcTglLahir.setDate(r.getDate("tanggal_lahir"));
            ...
            // isi kunjungan
            dcTglKunjungan.setDate(r.getDate("tanggal_kunjungan"));
...
private int selectedIdKunjungan = 0;
    ...
    private void initComponents() {
        ...
        dcTglKunjungan = new com.toedter.calendar.JDateChooser();
                        ...
                        .addGroup(pnlFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(pnlFormLayout.createSequentialGroup()
                                ...
                                .addGroup(pnlFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(dcTglKunjungan, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                            .addGroup(pnlFormLayout.createSequentialGroup()
        ...
        pnlFormLayout.setVerticalGroup(
            ...
            .addGroup(pnlFormLayout.createSequentialGroup()
                ...
                .addGroup(pnlFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(dcTglLahir, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(pnlFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGap(20, 20, 20)
                .addGroup(pnlFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(lblTglKunjungan, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(dcTglKunjungan, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(pnlFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    java.util.Date dLahir = dcTglLahir.getDate();
    String noHp = txtNoHp.getText().trim();

    java.util.Date dKunj  = dcTglKunjungan.getDate();
    String keluhan = txtKeluhan.getText().trim();
    String terapi = txtTerapi.getText().trim();
    
    if (dLahir == null || dKunj == null) {
    JOptionPane.showMessageDialog(this, "Pilih Tgl Lahir & Tgl Kunjungan dulu.");
    return;
    }

    java.sql.Date tglLahir = new java.sql.Date(dLahir.getTime());
    java.sql.Date tglKunjungan = new java.sql.Date(dKunj.getTime());
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        String jk = getJK();
        String alamat = txtAlamat.getText().trim();
        java.util.Date dLahir = dcTglLahir.getDate();       // YYYY-MM-DD
        String noHp = txtNoHp.getText().trim();               // boleh kosong
        java.util.Date dKunj  = dcTglKunjungan.getDate(); // YYYY-MM-DD
        String keluhan = txtKeluhan.getText().trim();
        String terapi = txtTerapi.getText().trim();
        String status = cmbStatus.getSelectedItem().toString();
    ...
    private com.toedter.calendar.JDateChooser dcTglKunjungan;
